...
<script>
  import AddOrUpdate from './registwork-add-or-update'
  ...
  export default {
    ...
    methods: {
      ...
      getData () {
        ...
        let url = `http://localhost:88/api/outpatientregistration/registwork/list/${this.currPage}`
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/xxxxxxxxxxxxx/registwork/delete'),
            method: 'post',
