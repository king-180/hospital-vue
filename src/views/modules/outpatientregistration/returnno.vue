<template>
  <div style="margin-top: 0px">
    <div><h3>患者信息查询</h3></div>
    <el-form :inline="true" label-width="80px" size="mini" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="病历号:">
        <el-input v-model="dataForm.key" placeholder="请输入病历号" clearable></el-input>
      </el-form-item>
      <el-form-item>
        <el-button icon="el-icon-search" type="primary" @click="getDataList()">搜索</el-button>
      </el-form-item>
    </el-form>

    <div class="mod-config">
      <div><h4>患者信息确认</h4></div>
      <el-form :inline="true" label-width="100px" size="mini" :model="dataForm" @keyup.enter.native="getDataList()">
        <el-form-item label="患者姓名:">
          <el-input v-model="dataForm.key" placeholder="请输入姓名" clearable></el-input>
        </el-form-item>
        <el-form-item label="身份证号:">
          <el-input v-model="dataForm.key" placeholder="请输入身份证号" clearable></el-input>
        </el-form-item>
        <el-form-item label="家庭住址:">
          <el-input v-model="dataForm.key" placeholder="请输入家庭住址" clearable></el-input>
        </el-form-item>
      </el-form>
      <el-table
        :data="pageInfo.list"
      ...
      <el-row :gutter="20" style="margin-top: 20px;margin-left: 5px">
        <el-col :span="6">
          <div style="margin-top: 10px">
            <el-form :inline="true" label-width="80px" size="mini" :model="dataForm"
                     @keyup.enter.native="getDataList()">
              <el-form-item>
                <el-button type="primary" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">收费结算
                </el-button>
              </el-form-item>
            </el-form>
          </div>
